...

{
  ...
  "insider_tips": "HTML numbered list of at least 7 honest, hard-won expat survival insights for ${city}. Written as if by someone who has actually lived it — blunt, practical, zero fluff. You MUST include the following universal truths where they apply to ${country}, adapted with local specifics: (1) Always carry $20–50 USD in small bills completely separate from your main wallet — at border crossings and bureaucratic dead-ends, the phrase 'I don't know what the legal fees are here' said calmly while holding a $20 bill resolves things faster than arguing; (2) Many countries will not issue a visa-on-arrival or stamp you in without proof of onward travel — services like Onward Ticket or a local travel agency can issue a refundable dummy ticket for $15–25 that satisfies this requirement; (3) Traveller's checks are useless in most of Asia — no one will cash them, including major banks; (4) If ${country} is Taiwan or South Korea, note that opening a local bank account typically requires a working visa or ARC — tourist visa holders will be turned away at most branches; (5) Culture shock rarely hits on day one — the first week feels like adventure, then week two arrives and ordinary things become exhausting. Reverse culture shock when you return home is equally real and underestimated; (6) If you ever hold permanent residency in ${country}, check the residency maintenance rule — many PR statuses void automatically after 180 days outside the country, with no warning and no grace period; (7) Never open your full wallet at a border crossing or when paying informal fees — keep a decoy amount visible and your emergency cash in a separate pocket or money belt. Then add ${city}-specific insights beyond these that locals and long-timers actually know."
}
